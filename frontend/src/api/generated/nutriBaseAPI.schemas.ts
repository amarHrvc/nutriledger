...
export type PatientsVisitsVitalsShow200 = { [key: string]: unknown };

export type PatientsVisitsVitalsShow501 = {
  /** Error overview. */
  message: string;
};

export type PatientsVisitsVitalsStore200 = { [key: string]: unknown };

export type PatientsVisitsVitalsStore501 = {
  /** Error overview. */
  message: string;
};

export type PatientsVisitsVitalsUpdate200 = { [key: string]: unknown };

export type PatientsVisitsVitalsUpdate501 = {
  /** Error overview. */
  message: string;
};

export type PatientsVisitsVitalsDestroy200 = { [key: string]: unknown };

export type PatientsVisitsVitalsDestroy501 = {
  /** Error overview. */
  message: string;
};

export type PatientsVitalsHistory200 = { [key: string]: unknown };

export type PatientsVitalsHistory501 = {
  /** Error overview. */
  message: string;
};
