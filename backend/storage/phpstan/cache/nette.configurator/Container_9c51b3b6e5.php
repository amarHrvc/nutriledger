...
class Container_9c51b3b6e5 extends _PHPStan_584420d24\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0436(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_9c51b3b6e5 $container)
			{
	...
	public function createServiceContainer(): Container_9c51b3b6e5
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'APP_KEY' => 'base64:Hcy/R2Qn1voJO5dr1SaVYryn7HdzLzvIjoSbiceIFQM=',
				'APP_LOCALE' => 'en',
